    ...
    if (this.props.data) {
      return (
        <View style={[{ flex:1, backgroundColor: this.props.postBackground},this.props.style]}>
              ...
              <View style={{flex: 1}}>
                ...
                <View style={{flex: 1, backgroundColor: 'rgba(0, 0, 0, 0.5)',justifyContent: 'flex-end'}}>
                  <View style={{paddingLeft: 10, paddingBottom: 10 }}>
                    ...
                    <Text style={{color: 'rgb(217, 217, 217)', fontSize: 13, marginBottom: 5, marginBottom: 10}}>{source[0]}
                    </Text>
                    <Text
                    numberOfLines={2}
                    ellipsizeMode="tail"
            ...
            <View style={{ width: width-20, height: height-width-80,margin: 10, marginTop: 0, flexDirection: 'row'}}>
              <TouchableOpacity
